...
const NEWS_VIDEOS = [
  {
    ...
    description: 'Imágenes reales de la evacuación de emergencia del MV Hondius durante el brote de Hantavirus en Ushuaia.',
  },
  {
    id: 'inside',
    title: 'Dentro del Brote — MV Hondius',
    embedUrl: 'https://www.youtube.com/embed/1rLIyzZwHTA',
    description: 'Reportaje exclusivo desde el interior del brote a bordo del barco de expedición antártica.',
  },
];
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        />
        <span
          className="font-bold tracking-[0.25em] uppercase text-red-400"
          style={{ fontSize: 'clamp(0.65rem, 1.5vw, 0.8rem)' }}
        >
          📡 Intelligence Feed — Noticias Reales
        </span>
      </div>
      <p
        className="text-neutral-500 text-xs tracking-wider mb-4"
        style={{ fontSize: 'clamp(0.55rem, 1.2vw, 0.7rem)' }}
      >
        Cobertura periodística real del brote del MV Hondius 2026. Fuentes verificadas.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {NEWS_VIDEOS.map((video) => (
          ...
          >
            ...
            <div className="p-3">
              <h4
                className="font-bold tracking-wider text-red-400 mb-1"
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(34,197,94,0.06) 0%, rgba(5,15,30,0.95) 100%)',
      ...
      >
        <div className="flex flex-col sm:flex-row gap-5 items-start">
          ...
          >
            ...
            <p className="text-bio-green/60 text-center mt-2 tracking-[0.2em] uppercase font-bold"
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-3">
              <motion.div
                className="w-2.5 h-2.5 rounded-full bg-bio-green"
                animate={{ opacity: [0.4, 1, 0.4], scale: [0.9, 1.1, 0.9] }}
                transition={{ duration: 1.5, repeat: Infinity }}
              />
              <span className="text-bio-green/80 text-xs tracking-[0.3em] uppercase font-bold">
                TRANSMISIÓN URGENTE
              </span>
            </div>
            ...
            >
              <div className="hidden sm:block absolute -left-2 top-6 w-4 h-4 rotate-45"
                style={{
                  background: 'rgba(34,197,94,0.04)',
              ...
              >
                <strong className="text-bio-green">¡Detective!</strong> Hay un brote en el{' '}
                <strong className="text-red-400">MV Hondius</strong>. Tu tarea es encontrar al{' '}
                <strong className="text-emergency">PACIENTE CERO</strong> examinando los sospechosos y sus bitácoras.{' '}
                <strong className="text-bio-green">¡Usa las pistas del barco!</strong>
              </p>
              <p className="text-neutral-300 leading-relaxed mb-3"
                style={{ fontSize: 'clamp(0.75rem, 2vw, 0.9rem)' }}
              >
                El <strong className="text-red-400">Hantavirus cepa Andes</strong> se transmite por contacto con roedores infectados.
                Es el <strong className="text-emergency">único hantavirus con transmisión persona-a-persona</strong> confirmada.
                Investiga cada rincón del barco y reúne las pruebas.
              </p>
              <div
      ...
      >
        ...
        <h2
          className="font-bold tracking-[0.15em] text-red-400 mb-2"
          style={{
        ...
        <p className="text-neutral-500 text-xs tracking-wider">
          Barco de expedición antártica • 48 horas después de zarpar • Brote confirmado
        </p>
      </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-neutral-600 text-xs tracking-wider mt-1">SELECCIONA UNA UBICACIÓN PARA INVESTIGAR</p>
      </div>
...
export default function HantavirusMission({ onNavigate }) {
  ...
  return (
    ...
    >
      ...
      {/* Intelligence Feed — always visible at top */}
      <IntelligenceFeed />
      ...
      <div className="border-t border-neutral-800/30 py-4 text-center mt-8">
        ...
        >
          Micropia v9.5 • Misión Hantavirus • Juego Educativo de Detective Epidemiológico
        </p>
      </div>
    </motion.div>
  );
